      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: theme.colors.background }]}>
          ...
          <ScrollView style={styles.modalBody}>
            {selectedTransaction && (
              <>
                <View style={[styles.statusContainer, { backgroundColor: getStatusBackgroundColor(selectedTransaction.status) }]}>
                ...
                <View style={styles.detailSection}>
                  <Text style={[styles.detailSectionTitle, { color: theme.colors.text }]}>Payment Information</Text>
                  
                  <View style={styles.detailItem}>
                    <Text style={{ color: theme.colors.text, opacity: 0.7 }}>Biller:</Text>
                    <Text style={{ color: theme.colors.text }}>{selectedTransaction.biller_name || 'N/A'}</Text>
                  </View>
                  
                  <View style={styles.detailItem}>
                    <Text style={{ color: theme.colors.text, opacity: 0.7 }}>Service:</Text>
                    <Text style={{ color: theme.colors.text }}>{selectedTransaction.service_name || 'N/A'}</Text>
                  </View>
                  ...
                  <View style={styles.detailItem}>
                    <Text style={{ color: theme.colors.text, opacity: 0.7 }}>Date:</Text>
                    <Text style={{ color: theme.colors.text }}>
                      {selectedTransaction.date ? format(new Date(selectedTransaction.date), 'MMM dd, yyyy HH:mm') : 'N/A'}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.detailSection}>
                  <Text style={[styles.detailSectionTitle, { color: theme.colors.text }]}>Transaction Details</Text>
                  
                  <View style={styles.detailItem}>
                    <Text style={{ color: theme.colors.text, opacity: 0.7 }}>Reference:</Text>
                    <Text style={{ color: theme.colors.text }}>{selectedTransaction.reference || 'N/A'}</Text>
                  </View>
                  
                  <View style={styles.detailItem}>
                    <Text style={{ color: theme.colors.text, opacity: 0.7 }}>Payment Method:</Text>
                    <Text style={{ color: theme.colors.text }}>{selectedTransaction.payment_method || 'N/A'}</Text>
                  </View>
                  
                  {selectedTransaction.customer_id && (
                    <View style={styles.detailItem}>
                      <Text style={{ color: theme.colors.text, opacity: 0.7 }}>Customer ID:</Text>
                      <Text style={{ color: theme.colors.text }}>{selectedTransaction.customer_id}</Text>
                    </View>
                  )}
                </View>
