...
export default function ProfileScreen() {
	...
	useEffect(() => {
		if (profileData) {
			let name = `${profileData.first_name} ${profileData.last_name || ''}`.trim();
			setPersonalValue('name', name || '');
		...
		<Card style={[styles.card, {backgroundColor: theme.colors.background}]}>
			<Card.Content>
				...
				{passwordErrors.currentPassword &&
					<Text style={styles.errorText}>{passwordErrors.currentPassword.message}</Text>}
				...
				{passwordErrors.newPassword &&
					<Text style={styles.errorText}>{passwordErrors.newPassword.message}</Text>}
